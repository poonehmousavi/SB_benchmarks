...
class ASR(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        z_combined = self.modules.merging_adapter(wavs.unsqueeze(1)) # [B, T, D]
        in_embs = self.modules.audio_adapter(z_combined) # [B, T, D]
...
if __name__ == "__main__":
    ...
    if hparams["testing"]:
        ...
        for k in test_datasets.keys():  # keys are test_clean, test_other etc
            ...
            asr_brain.modules.merging_adapter.export_mixing_weights(hparams["output_folder"])
