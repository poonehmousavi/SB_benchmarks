...
def compute_embedding(in_toks, wav_lens):
    ...
    with torch.no_grad():
        ...
        # if  hasattr(speaker_brain.hparams,'embedding_strg') and  speaker_brain.hparams.embedding_strg == 'concat':
        ...
        #         -2
        #     )  # [B, T, D]
        in_embs = speaker_brain.modules.weighted_ssl_model(
            in_toks
        )  # 
...
class SpeakerBrain(sb.core.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        #         -2
        #     )  # [B, T, D]
        in_embs = self.modules.weighted_ssl_model(
            wavs
        ) 
